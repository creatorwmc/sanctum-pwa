...
// Mock firebase functions for Practice Space integration
// These features are optional - game works without them
const submitRating = async () => {};
const getAllRatings = async () => [];
const trackUser = async () => {};
const updateUserStats = async () => {};
const getUserStats = async () => null;
const isAdminDevice = () => false;
const getCurrentDeviceId = () => 'practice-space-user';
